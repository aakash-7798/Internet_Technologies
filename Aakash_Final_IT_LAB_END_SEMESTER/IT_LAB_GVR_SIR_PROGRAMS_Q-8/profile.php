    ...
    echo "<br><br><br><center><h3>  MY PERSONAL INFORMATION  </h3></center><br>".
          "<center><p>".
            ...
            "LastName     = {$data_query_result[0][1] }<br><br>".
             ...
             "Address     = {$data_query_result[0][7]}</p></center>";
//    print_r($data_query_result);
}
else{
    echo "<br><br><center><h3>Invalid Password !!!!....</h3></center>".
    "<br><br> <center><h1>Your Attempt is Unsuccessfull  <span style='color: red; font-size:30px'>&#x274C;</span></h1></center> <br><br>".
    "<center><h4>Enter Your Password Once Again</h4> <p> &#128542; </p> </h4>".
